...
export function WeekdayRevenueBarChart({ transactions }: WeekdayRevenueBarChartProps) {
  ...
  const sampledDaysCount = chartData.reduce((sum, bucket) => sum + bucket.dayCount, 0);
    ...
    <Card className="p-6">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Calculated from {sampledDaysCount} weekday(s) with transactions. Weekends are excluded.
        </p>
      </div>
